...
const ALIBABA_TOKEN_PLAN_OVERRIDES: Record<string, ModelMetadata> = {
  'qwen-image-2.0': { capabilities: { chat: false, imageGeneration: true } },
  'qwen-image-2.0-pro': { capabilities: { chat: false, imageGeneration: true } },
};
...
const STATIC_MODEL_METADATA: Partial<Record<ProviderType, Record<string, ModelMetadata>>> = {
  ...
  'alibaba-token-plan-cn': ALIBABA_TOKEN_PLAN_OVERRIDES,
  'alibaba-token-plan': ALIBABA_TOKEN_PLAN_OVERRIDES,
  'tencent-coding-plan': {
  ...
  nvidia: {
    ...
    'nvidia/magpie-tts-zeroshot': { capabilities: { chat: false } },
