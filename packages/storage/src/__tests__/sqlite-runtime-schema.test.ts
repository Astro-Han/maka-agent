    ...
    try {
      ...
      db.exec(`
        ...
        INSERT INTO runtime_continuation_claims VALUES (
          ...
          '{"runId": "target-run-v1", "invocationId": "target-invocation-v1", "sessionId": "session", "turnId": "target-turn-v1", "status": "created", "backendKind": "fake", "llmConnectionSlug": "connection-1", "modelId": "model-1", "cwd": "/workspace", "sandboxMode": "workspace-write", "createdAt": 1, "updatedAt": 1}',
          1, NULL, NULL, 1
        );
