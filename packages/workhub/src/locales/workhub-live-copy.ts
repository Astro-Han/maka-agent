...
export const workHubLiveCopy = {
  en: {
    ...
    navigationGesture:
      'Click to locate conversations; click again to filter; click once more to show all',
    attachmentLimit: 'Attachment count or size exceeds the limit',
    attachmentUploadFailed: 'Attachment upload did not return a reference',
    ...
    progressTitle: 'WorkHub progress',
    progressWorking: 'Working',
    progressPaused: 'Paused',
    progressError: 'Needs attention',
    progressDone: 'Finished',
    progressHint: 'You can keep working in Maka.',
    progressOpen: 'View conversation',
    progressClose: 'Hide progress for this task',
    title: 'WorkHub',
    ...
    delegationWaiting: 'Waiting for user',
    delegationCompleted: 'Completed',
    delegationFailed: 'Failed',
    delegationAborted: 'Aborted',
    delegationRecovering: 'Recovering',
    openWork: 'Open task',
  ...
  'zh-CN': {
    ...
    navigationGesture: '点击定位对话；再点筛选；再次点击显示全部',
    attachmentLimit: '附件数量或大小超过限制',
    ...
    progressTitle: 'WorkHub 进度',
    progressWorking: '正在处理',
    progressPaused: '已暂停',
    progressError: '需要查看',
    progressDone: '本轮已结束',
    progressHint: '你可以继续在 Maka 中操作。',
    progressOpen: '查看对话',
    progressClose: '本轮不再显示进度',
    title: '工作台',
    progressInput: '补充一句…',
    float: '浮出工作台',
    dock: '收回 Maka',
    ...
    floating: '工作台已在浮窗中打开',
    restore: '收回工作台',
    delegationAccepted: '已接收',
    delegationRunning: '进行中',
    delegationWaiting: '等待用户',
    delegationCompleted: '已完成',
    delegationFailed: '失败',
    delegationAborted: '已中止',
    delegationRecovering: '正在恢复',
    openWork: '打开任务',
    openResult: '打开结果',
  },
  'zh-TW': {
    ...
    navigationGesture: '點擊定位對話；再點篩選；再次點擊顯示全部',
    attachmentLimit: '附件數量或大小超過限制',
    ...
    progressTitle: 'WorkHub 進度',
    progressWorking: '正在處理',
    progressPaused: '已暫停',
    progressError: '需要查看',
    progressDone: '本輪已結束',
    progressHint: '你可以繼續在 Maka 中操作。',
    progressOpen: '查看對話',
    progressClose: '本輪不再顯示進度',
    title: '工作台',
    progressInput: '補充一句…',
    float: '浮出工作台',
    dock: '收回 Maka',
    ...
    restore: '收回工作台',
    delegationAccepted: '已接收',
    delegationRunning: '進行中',
    delegationWaiting: '等待使用者',
    delegationCompleted: '已完成',
    delegationFailed: '失敗',
    delegationAborted: '已中止',
    delegationRecovering: '正在恢復',
    openWork: '開啟任務',
    openResult: '開啟結果',
  },
