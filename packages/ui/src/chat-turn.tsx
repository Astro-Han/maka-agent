      ...
      {conversationSegments.map((segment, segmentIndex) => {
        ...
        return (
          <Fragment key={assistantKey}>
            ...
            {ownsTurnChrome && (footerMeta || finishedAt !== undefined || footerActions.length > 0) && (
              <TurnFooter
...
export function TurnFooter(props: {
  ...
  const hasFooterContent =
    props.meta !== undefined || props.actions.length > 0;
  const isToolbar = !props.live && (props.actions.length > 0);
  return (
    <ChatMessageMetadata
