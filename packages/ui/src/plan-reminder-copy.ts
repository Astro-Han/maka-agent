...
const PLAN_REMINDER_COPY = {
  ...
  en: {
    ...
    form: {
      editTitle: 'Edit scheduled task', createTitle: 'New scheduled task', useTemplate: 'Use template', groupSchedule: 'Frequency', groupDelivery: 'Delivery', field: { title: 'Title', time: 'Reminder time', at: 'Time', channel: 'Method', recurrence: 'Repeat', platform: 'Platform', cron: 'Cron', chatId: 'Chat ID', note: 'Notes' }, timePlaceholder: 'YYYY-MM-DDTHH:mm', titlePlaceholder: 'For example: Review project progress tomorrow', presetsAriaLabel: 'Quick reminder times', presets: [['ten-minutes', 'In 10 minutes'], ['one-hour', 'In 1 hour'], ['tomorrow-morning', 'Tomorrow at 9:00'], ['next-monday', 'Next Monday at 9:00']], recurrenceOptions: [['none', 'Does not repeat'], ['daily', 'Daily'], ['weekly', 'Weekly'], ['monthly', 'Monthly'], ['cron', 'Cron']], deliveryOptions: [['local', 'Local notification'], ['bot', 'Bot chat']], cronPlaceholder: 'For example 0 9 * * 1-5', chatIdPlaceholder: 'For example Telegram chat_id', deliveryHelp: (providers) => `Available delivery providers: ${providers}. Other bot platforms are not shown as delivery targets.`, notePlaceholder: 'Optional context for this reminder', saving: 'Saving…', creating: 'Creating…', save: 'Save', create: 'Create',
    },
    page: {
