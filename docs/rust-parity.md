...
| Session lineage | Branch/revision create/abandon. Regeneration is removed; edits use revision and resend. Ordinary resume/startup recovery exist. | **Host.** One transactional lineage and workspace authority; plugins may request changes through commands, not reproduce them in private storage. |
