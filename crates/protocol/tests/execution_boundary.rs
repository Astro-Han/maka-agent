...
fn boundary_projection_matches_source_closed_variants_identity_and_revision_limits() {
    ...
    for value in [
        ...
        json!({"kind":"danger-full-access","revision":1.0}),
        json!({"kind":"external","revision":9007199254740991u64}),
        json!({"kind":"managed","access":"write","revision":0}),
        json!({"kind":"managed","revision":0}),
        json!({"kind":"danger-full-access","access":"writable","revision":0}),
        json!({"kind":"danger-full-access","revision":-1}),
        json!({"kind":"danger-full-access","revision":0.5}),
        json!({"kind":"danger-full-access","revision":9007199254740992u64}),
        json!({"kind":"danger-full-access","revision":"1"}),
        json!({"kind":"external"}),
