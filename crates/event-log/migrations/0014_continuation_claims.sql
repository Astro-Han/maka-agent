...
-- The canonical opening is the claim. These indexes add no independent state.
CREATE UNIQUE INDEX continuation_claim_id ON runtime_events (
...
CREATE UNIQUE INDEX continuation_source_boundary ON runtime_events (
