...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  'zh-CN': {
    ...
    sections: {
      ...
      shell: '命令行环境', shellHelp: '选择 Runtime Host 执行 Shell 工具和终端命令时使用的 shell。',
  ...
  'zh-TW': {
    ...
    sections: {
      ...
      shell: '命令列環境', shellHelp: '選擇 Runtime Host 執行 Shell 工具和終端命令時使用的 shell。',
  ...
  en: {
    ...
    sections: {
      ...
      shell: 'Command environment', shellHelp: 'Choose the shell the Runtime Host uses for Shell tools and terminal commands.',
