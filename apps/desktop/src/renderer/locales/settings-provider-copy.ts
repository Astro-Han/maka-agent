...
const zhCopy = {
  detail: {
    ...
    exactModelId: '精确模型 ID', exactModelIdPlaceholder: '输入供应商使用的模型 ID', addExactModel: '添加并启用',
    exactModelIdHelp: '目录中没有时，可直接启用精确 ID；是否可用会在请求时确认。',
    ...
    modelsFetchFailedDetail: (message: string, troubleshooting: string) => `${message} · 当前继续显示已有列表，请确认 ${troubleshooting} 后重试。`,
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    exactModelId: 'Exact model ID', exactModelIdPlaceholder: 'Enter the model ID used by the provider', addExactModel: 'Add and enable',
    exactModelIdHelp: 'If the model is missing from the catalog, enable its exact ID. Availability is confirmed when you make a request.',
    ...
    modelsFetchFailedDetail: (message: string, troubleshooting: string) => `${message} · The existing list remains visible. Check ${troubleshooting} and try again.`,
