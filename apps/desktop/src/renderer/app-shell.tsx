...
import { RuntimeHostHandoffOverlay } from './features/runtime-host-management';
...
function AppShellContent({
  ...
  const isOnboardingLoading = !hasSessions && onboardingState === undefined && !onboardingSettled && !onboarding.error;
  ...
  const titlebarParentSession = useMemo(() => {
    const parent = activeParentSession;
      ...
      <AstryxAppShell
        ...
        sideNav={
              <SessionNavigationProvider
                ...
                onNewProject={taskEntry.selectors.canAddProject ? taskEntry.commands.openNewProject : undefined}
              >
                {SESSION_RAIL}
              </SessionNavigationProvider>
        }
