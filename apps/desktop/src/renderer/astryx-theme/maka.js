...
export const makaTheme = {
  ...
  tokens: {
    ...
    "--radius-page": "1.75rem",
    "--radius-full": "9999px",
    "--shadow-low": "inset 0 1px 0 light-dark(oklch(1 0 0 / 64%), oklch(1 0 0 / 6%)), 0 0 2px light-dark(oklch(0 0 0 / 2%), oklch(0 0 0 / 22%)), 0 0 6px light-dark(oklch(0 0 0 / 3%), oklch(0 0 0 / 30%)), 0 6px 30px light-dark(oklch(0 0 0 / 7%), oklch(0 0 0 / 45%))",
