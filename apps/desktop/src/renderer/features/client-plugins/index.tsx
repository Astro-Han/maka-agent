...
export function ClientPluginComposerSlot(props: {
  ...
  const input: ClientSdk.ClientSlots['session.composer.before'] = {
    ...props.input,
    onOpenSession(sessionId) {
      void transport.session(sessionId).then(props.input.onOpenSession).catch((error: unknown) => report({ error }));
    },
  };
  return <>
    ...
    {runtime ? <ClientSlot store={runtime.slots} name="session.composer.before" input={input}
