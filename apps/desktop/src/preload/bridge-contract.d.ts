...
export interface MakaBridge {
  ...
  sessions: {
    ...
    queryTurn(sessionId: string, turnId: string): Promise<OperationOutput<'turn.query'>>;
  ...
  connections: {
    getProviders(host?: DesktopRuntimeHostRef): Promise<import('@maka/runtime-host/client').RuntimeHostModelProviderCatalogSnapshot>;
    getSnapshot(sessionId?: string, host?: DesktopRuntimeHostRef): Promise<DesktopConnectionSnapshot>;
    setDefault(connection: import('../shared/desktop-connection-snapshot').DesktopConnectionIdentity | null, host?: DesktopRuntimeHostRef): Promise<void>;
    ...
    test(connection: import('../shared/desktop-connection-snapshot').DesktopConnectionIdentity, opts?: { model?: string }, host?: DesktopRuntimeHostRef): Promise<ConnectionTestResult>;
